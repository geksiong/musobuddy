...
const ABCM2PS_PATTERNS: Array<{ pattern: RegExp; description: string }> = [
  ...
  { pattern: /^%%mdnn\b/m, description: '%%mdnn numbered notation directive' },
  { pattern: /^%%gamelan\b/m, description: '%%gamelan notation directive' },
  { pattern: /^%%clairnote\b/m, description: '%%clairnote notation directive' },
  { pattern: /^%%clair\b/m, description: '%%clair notation directive' },
