...
export const DEFAULT_PRESETS: BeatPattern[] = [
  ...
  {
    id: 'flamenco-3-beat',
    name: 'Sevillanas / Fandangos (3-Beat)',
    bpm: 120,
    timeSignature: '3/4',
    voices: [
      { id: 0, sound: MetronomeSound.Woodblock, volume: 1, beats: 3, active: true, muted: false, pattern: [2, 1, 1] },
      { id: 1, sound: MetronomeSound.Clap, volume: 0.8, beats: 6, active: true, muted: false, isDoubleTime: true, pattern: [2, 1, 1, 1, 2, 1] },
    ],
    countIn: false,
    type: TimeSignatureType.Flamenco,
    startBeat: 1,
  ...
  {
    id: 'flamenco-6-beat-222',
    name: '6-Beat Flamenco (2+2+2)',
    bpm: 120,
    timeSignature: '6/8',
    voices: [
      { id: 0, sound: MetronomeSound.Woodblock, volume: 1, beats: 6, active: true, muted: false, pattern: [2, 1, 2, 1, 2, 1] },
