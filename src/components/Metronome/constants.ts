...
export const DEFAULT_PRESETS: BeatPattern[] = [
  ...
  },
  {
    ...
    name: '4/4 Jazz Swing',
    bpm: 110,
    timeSignature: '4/4 (Swing)',
    swingRatio: 0.667,
    voices: [
      { id: 0, sound: MetronomeSound.Kick, volume: 1, beats: 4, active: true, muted: false, pattern: [2, 0, 1, 0] },
      { id: 1, sound: MetronomeSound.HiHat, volume: 0.8, beats: 8, active: true, muted: false, isSwing: true, pattern: [2, 1, 2, 1, 2, 1, 2, 1] },
      { id: 2, sound: MetronomeSound.Clap, volume: 0.8, beats: 4, active: true, muted: false, pattern: [0, 2, 0, 2] },
    ],
    countIn: true,
    type: TimeSignatureType.Standard,
  ...
  {
    id: 'triple-time-triplets',
    name: '4/4 Triplets (3x)',
    bpm: 90,
    timeSignature: '4/4 (3x Triplets)',
    voices: [
      { id: 0, sound: MetronomeSound.Kick, volume: 1, beats: 4, active: true, muted: false, pattern: [2, 0, 1, 0] },
      { id: 1, sound: MetronomeSound.HiHat, volume: 0.75, beats: 12, active: true, muted: false, isTripleTime: true, pattern: [2, 1, 1, 2, 1, 1, 2, 1, 1, 2, 1, 1] },
      { id: 2, sound: MetronomeSound.Clap, volume: 0.8, beats: 4, active: true, muted: false, pattern: [0, 2, 0, 2] },
    ],
    countIn: true,
    type: TimeSignatureType.Standard,
