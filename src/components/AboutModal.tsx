      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
        ...
        >
          ...
          <div className="p-6 overflow-y-auto space-y-8 custom-scrollbar">
            ...
            {/* PWA & Offline Readiness Banner */}
            <div className={cn(
              "p-5 rounded-2xl border flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-all",
              resolvedTheme === 'dark' ? "bg-indigo-950/30 border-indigo-500/30 text-indigo-100" : "bg-indigo-50/80 border-indigo-200 text-indigo-950"
            )}>
              <div className="flex items-start gap-3.5">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <h4 className="text-xs font-extrabold uppercase tracking-wider">Progressive Web App (PWA)</h4>
                    <span className={cn(
                  ...
                  <p className="text-xs opacity-80 leading-relaxed">
                    MusoBuddy works as a native application with offline caching for core practice tools, score rendering engines, soundfonts, and tuner microphone processing.
                  </p>
                  <div className="flex items-center gap-3 pt-1 text-[11px] font-medium opacity-75">
                    <span className="flex items-center gap-1">
                      {isOffline ? <WifiOff className="w-3.5 h-3.5 text-amber-400" /> : <Wifi className="w-3.5 h-3.5 text-emerald-400" />}
                      {isOffline ? "Currently Offline" : "Online & Synchronized"}
                    </span>
                    <span>•</span>
                    <span>Offline Caching Engine Active</span>
                  </div>
                </div>
              </div>
              ...
              {isInstallable && (
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs uppercase tracking-wider transition-all flex items-center gap-2 shrink-0 shadow-lg shadow-indigo-600/30 self-stretch md:self-auto justify-center"
                >
